...
import { RoleSelect, SignupScreen, CreateAccount, VerifyPhone2 } from "./pages/tenant/auth/Onboarding"
import AgentSignup from "./pages/agent/auth/Signup";
...
import Verification from "./pages/agent/onboarding/Verification";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/tenant/signup/start" element={<SignupScreen />} />
        ...
        {/* FIX: added /:id so the property id travels through the URL */}
        <Route path="/ListingProperty/:id" element={<ListingsProperty />} />
