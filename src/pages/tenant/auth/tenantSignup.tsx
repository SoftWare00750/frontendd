...
//   <Route path="/tenant/signup/verify"  element={<VerifyPhone />} />
...
export function CreateAccount() {
  ...
  const [showConfirmPw, setShowConfirmPw] = useState(false); // ← added
  ...
  // ── Generic field renderer (handles both password fields) ──
  const renderField = (
    label: string,
    key: keyof FormState,
    placeholder: string,
    ...
    // Determine which show-state to use for password fields
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", backgroundImage: "url('/assets/background1.png')", backgroundSize: "cover", backgroundPosition: "center", overflow: "hidden" }}>
          ...
          <div style={{
            ...
            <div style={{ width: "100%", maxWidth: 380 }}>
              ...
              {renderField("Email (Optional)", "email", "your.email@example.com", "email", false)}
              ...
              <p style={{ textAlign: "center", fontSize: 13, marginTop: 8 }}></p>
            </div>
          </div>
